...
with st.sidebar:
    ...
    st.markdown(
        ...
        Et dessiner un rectangle d'une largeur d'environ <strong>1/10 la taille de la carte et de hauteur d'environ 1/5 </strong>.<br>
...
- Dessinez un rectangle en utilisant l'outil ⬛ pour déterminer une zone sur laquelle lancer la prédiction, puis cliquez sur **Exporter PNG** 
